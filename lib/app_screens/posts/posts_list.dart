...
class _PostsListState extends State<PostsList> {
  ...
  Future<List<Post>> showPosts() async {
    var data = await http.get('https://landela.org/mobileapi/blog/categories/posts/actualites');
                            ...
                            child: GestureDetector(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Divider(),
                                  Text(snapshot.data[index].title, style: TextStyle(fontSize: 20.0),), // overflow: TextOverflow.ellipsis,
                                  Divider(),
